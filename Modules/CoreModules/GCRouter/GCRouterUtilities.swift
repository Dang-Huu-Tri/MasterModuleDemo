...
public class GCRouterUtilities {
    ...
    public class func backToRoot(animated: Bool = false, completion: GCRouterUtilities.VoidCallback? = nil) {
        guard let root = GCRouterUtilities.rootViewController else { return }
    ...
    public class func topViewController(_ base: UIViewController? = GCRouterUtilities.rootViewController) -> UIViewController? {
